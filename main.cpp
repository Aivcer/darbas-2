...
int main()
{
    ...
    while( r == 1)
    {
        ...
        C = new double [1];
        int s;
        cout << "Jei norite pazymius generuoti atsitiktinai irasykite 1, o jei vesite patys, rasykite 0" << endl;
        cin >> s;
        if ( s == 1)
        {
            n=rand()%10+1;
        ...
        cout << "Kokie jusu egzamino rezultatai? Nuo 1 iki 10." << endl;
        cin.clear();
        cin.ignore(numeric_limits<streamsize>::max(), '\n');
        cin >> er[k];
